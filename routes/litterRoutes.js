...
router.get('/:id_public/offspring', async (req, res) => {
    try {
        ...
        const animals = await Animal.find(
            { id_public: { $in: ids } },
            { id_public: 1, ownerId_public: 1, name: 1, prefix: 1, suffix: 1, gender: 1, birthDate: 1, species: 1, imageUrl: 1, photoUrl: 1, status: 1, isDisplay: 1, sireId_public: 1, damId_public: 1, color: 1, coat: 1, breederId_public: 1, isOwned: 1, archived: 1 }
        ).lean();
