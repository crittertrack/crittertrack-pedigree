...
const ANIMAL_SAFE = new Set([
    ...
    'lastFedDate','feedingIntervalHours',
    ...
    'coatPattern','lifeStage','carrierTraits','morph','markings',
    ...
    'origin','isNeutered','heatStatus','lastHeatDate','ovulationDate',
    ...
    'isDamAnimal','estrusCycleLength',
    'gestationLength','artificialInseminationUsed',
    ...
    'dietSupplies','supplementSupplies',
