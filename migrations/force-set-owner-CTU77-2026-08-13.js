// Admin data fix: for CTC2725, CTC2726, CTC2727 — fully strip any transfer relationship and
// force current ownership to CTU77. Same logic as force-set-owner-CTU2-2026-08-13.js.
require('dotenv').config();
const mongoose = require('mongoose');
const { Animal, AnimalTransfer, PublicAnimal, User } = require('../database/models');

const ANIMAL_IDS = ['CTC2725', 'CTC2726', 'CTC2727'];
const TARGET_OWNER_PUBLIC_ID = 'CTU77';
