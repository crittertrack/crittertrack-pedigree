// Second pass: extends the wildcard cleanup to CTU8 (remaining Re/Spl/Avy tokens) and applies the
// same policy as the first pass to CTU6, CTU11, CTU28.
//   Go/-, E/-, P/-, B/-, D/-, Rst/-, Sa/-, C/-, S/-  -> removed entirely
//   A/- -> A/a, Re/- -> Re/re, Spl/- -> Spl/spl, Avy/- -> Avy/a
...
const REPLACE_TOKENS = { 'A/-': 'A/a', 'Re/-': 'Re/re', 'Spl/-': 'Spl/spl', 'Avy/-': 'Avy/a' };
...
(async () => {
  ...
  const animals = await Animal.find({
    creatorId_public: { $in: ['CTU8', 'CTU6', 'CTU11', 'CTU28'] },
    geneticCode: { $regex: /\/-/ },
