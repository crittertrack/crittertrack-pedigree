...
// Mount the existing upload router so its routes (e.g. /upload) are available under /api
...
// Upload endpoints are handled by the mounted router (routes/uploadRoutes.js)
